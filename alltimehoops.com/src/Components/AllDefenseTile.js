...
function AllDefenseTile({ year, setIsLoading }) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (docSnap.exists()) {
                ...
                const allDefensePlayers = seasonData.players.filter(player => player.type === 'All-Defense');

                // Separate players into teams
                const teams = {};
                allDefensePlayers.forEach(player => {
